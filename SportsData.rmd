...
- For those more comfortable with Python, Daniel [scrapes](http://danielfrg.com/blog/2013/04/01/nba-scraping-data/) games and player stats, and Greg [digs into](http://www.gregreda.com/2015/02/15/web-scraping-finding-the-api/) the league's API. Additionally, tutorials from [Savvas](http://savvastjortjoglou.com/tag/python.html) stand alone. 
