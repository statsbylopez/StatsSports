...
4. Make a scatter plot of runs batted in (RBI, the x-variable) and home runs (HR, the x-variable). Estimate and write the regression line using the `lm` command. Finally, interpret the slope and intercept of this line.
...
14. Repeat the code in No. 13, only for HR rate. Have hitters been hitting less home runs with the increase in strikeouts?
